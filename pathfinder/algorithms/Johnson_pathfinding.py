...
# Utiliser l'algorithme de Johnson pour trouver tous les plus courts chemins entre chaque paire de nœuds
plus_courts_chemins = nx.johnson(graphe, weight='weight')
...
if depart in plus_courts_chemins and arrivee in plus_courts_chemins[depart]:
    chemin = plus_courts_chemins[depart][arrivee]
